...
C = 5.0; %const for smooth min/max operation %for 2 drones, use 10 with a period of 5s, casadi is unstable numerically
C1 =5.0; %const for smooth max %20 works for 10 drones, det init points
